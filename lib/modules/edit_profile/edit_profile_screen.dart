            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      defaultTextFormField(type: TextInputType.text,label: 'Name',border: OutlineInputBorder(),prefix: Icons.person,controller: nameController),
                      SizedBox(height: 10,),
                      defaultTextFormField(type: TextInputType.number,label: 'Age',border: OutlineInputBorder(),prefix: Icons.info_outline,controller: ageController),
                      SizedBox(height: 10,),
