...
class DashboardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    int inStockProducts = AdminCubit
        .get(context)
        .stockProducts
        .length;

    int notInStockProducts = AdminCubit
        .get(context)
        .products
        .length - inStockProducts;

    int countAllUsers = AdminCubit
        .get(context)
        .users
        .length;
